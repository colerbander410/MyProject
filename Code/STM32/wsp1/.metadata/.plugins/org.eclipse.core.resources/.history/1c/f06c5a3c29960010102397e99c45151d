...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
uint8_t dht11[50];  // buffer for sending via UART
uint8_t receivedData[1]; // receive data via UART
/* USER CODE END 0 */
...
int main(void)
{
  ...
  MX_USART1_UART_Init();
  MX_TIM4_Init();
  // Creating a DHT11 sensor object connected to pin, data line pull-up disabled
  /* USER CODE BEGIN 2 */
  static DHT_sensor test = {DHT11_GPIO_Port, DHT11_Pin, DHT11, GPIO_NOPULL};
  /* USER CODE END 2 */
